...
| GRADLE_HOME | E:\develop\gradle-7.0.1 |
| ----------- | ----------------------- |
...
groovy是java虚拟机的一种敏捷动态语言,面向对象,又可以用作纯粹的脚本语言,具有闭包和动态语言的其他特性
...
class ProjectVersion{
    ...
    //groove默认带有get set 方法,不用显式配置
    int getMajor() {
        //groove返回最后一个参数,可以不用写return
        major
    }
...
gradle有两个基本概念是项目(project)和任务(task),每个构建至少包含一个项目,一个或多个任务

![image-20210511164440487](C:\Users\leoalasiga\AppData\Roaming\Typora\typora-user-images\image-20210511164440487.png)

项目:

代表你正在构建的一个组件,当构建启动后,gradle会基于build.gradle实例化一个org.gradle.api.Project类,并且能能够通过project变量使其隐式可用
...
//        force 'org.slf4j:slf4j-api:1.7.24' //强制指定
//    }
//}
...
//        exclude group: 'org.slf4j', module: 'slf4j-api' //指定排除
//    }
    compile 'com.newrelic.logging:logback11:2.2'
...
![image-20210511165921157](C:\Users\leoalasiga\AppData\Roaming\Typora\typora-user-images\image-20210511165921157.png)

![image-20210511170006421](C:\Users\leoalasiga\AppData\Roaming\Typora\typora-user-images\image-20210511170006421.png)
...
![image-20210511170207314](C:\Users\leoalasiga\AppData\Roaming\Typora\typora-user-images\image-20210511170207314.png)
